RoleTaskInfo22012 =
{
	...
	subtask1 =
	{
		...
		oncheck =
		{
			{s_checkRolePosition, {5, 226, 390, 3, "在军乐城坐标(226,390)附近使用"}},
		},
		onstartbar =
		{
		...
		onsuccess =
		{
			...
			{s_actionAddItem,{31177, 0, 1, 0,"1-1", "RoleTaskInfo22012_1"}},
		},
		onfail =
		{
		...
		onfinish =
		{
			{s_actionDeleteItemByBaseID,{31177,1,"RoleTaskInfo22012_1"}},
		},
	},
}
