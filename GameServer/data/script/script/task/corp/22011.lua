RoleTaskInfo22011 =
{
	...
	subtask1 =
	{
		...
		oncheck =
		{
			{s_checkRolePosition, {7, 97, 560, 3, "在遗忘沙漠坐标(97,560)附近使用"}},
		},
		onstartbar =
		{
		...
		onsuccess =
		{
			...
			{s_actionAddItem,{31177, 0, 1, 0, "1-1", "RoleTaskInfo22011_1"}},
		},
		onfail =
		{
		...
		onfinish =
		{
			{s_actionDeleteItemByBaseID,{31177,1,"RoleTaskInfo22011_1"}},
		},
	},
}
