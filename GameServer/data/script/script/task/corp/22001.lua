RoleTaskInfo22001 =
{
	...
	subtask1 =
	{
		...
		oncheck =
		{
			{s_checkRolePosition, {4, 393, 121, 3, "在燃烧平原坐标(393,121)附近使用"}},
		},
		onstartbar =
		{
		...
		onsuccess =
		{
			...
			{s_actionAddItem,{31177, 0, 1,0, "1-1", "RoleTaskInfo22001_1"}},
		},
		onfail =
		{
		...
		onfinish =
		{
			{s_actionDeleteItemByBaseID,{31177,1,"RoleTaskInfo22001_1"}},
		},
	},
}
