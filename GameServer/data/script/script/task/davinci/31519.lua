RoleTaskInfo31519 =
{
	...
	subtask1 =
	{
		...
		desctext = ([[<p><newline/><n font="3" color="GXColorYellow">[随机]浪漫情缘</n><newline/><image pack="INTERFACE_PACK" infoname="INTERFACE_40_4_P"/><newline/><n font="3" color="GXColorYellow">任务进程：</n><newline/><n>    通过</n><goto id="198" mapid="5" flagpoint="1" taskid="31519"/><n>前往</n><n color='GXColorGreen'>婚礼殿堂</n><n>寻找</n><goto id="203" mapid="156" flagpoint="1" taskid="31519"/><n>。</n></p>]]),
		prompttext = [[   需要找到罗密欧。]],
		traceend = [[<p><newline/><n>通过：</n><goto id="198" mapid="5" flagpoint="1" taskid="31519"/><newline/><n>进入婚礼殿堂回复</n><newline/><goto id="203" mapid="156" flagpoint="1" taskid="31519"/></p>]],
	...
	{
		color = TaskColor_White,
		desctext = ([[<p><newline/><n font="3" color="GXColorYellow">[随机]浪漫情缘</n><newline/><image pack="INTERFACE_PACK" infoname="INTERFACE_40_4_P"/><newline/><n font="3" color="GXColorYellow">任务进程：</n><newline/><n color="GXColorGreen">    收集3朵花和3只蝴蝶，回复</n><goto id="204" mapid="156" flagpoint="1" taskid="31519"/><newline/><n>    男性角色可在本场景中采集到花，女性角色可在本场景捕捉到蝴蝶，道具可交易，可以通过向异性玩家索取。</n><newline/></p>]]),
		prompttext = [[   我需要3朵花和3只蝴蝶，可在本地图中寻找，其中一种只有异性才采集的到哦~~~]],
		tracebegin = [[<p><newline/><n>采集3朵花和3只蝴蝶后回复：</n><newline/><goto id="204" mapid="156" flagpoint="1" taskid="31519"/></p>]],
		traceend = [[<p><newline/><n>采集3朵花和3只蝴蝶后回复：</n><newline/><goto id="204" mapid="156" flagpoint="1" taskid="31519"/></p>]],
		...
		onfinish=
		{
			...
			{s_actionAddExp, {15000, ExpType_OptionalTask,31519}},
		},
	},
	subtask3 =
	{
		color = TaskColor_White,
		desctext = ([[<p><newline/><n font="3" color="GXColorYellow">[随机]浪漫情缘</n><newline/><image pack="INTERFACE_PACK" infoname="INTERFACE_40_4_P"/><newline/><n font="3" color="GXColorYellow">任务进程：</n><newline/><n>    与异性组队拥抱或依偎1分钟，回复</n><goto id="204" mapid="156" flagpoint="1" taskid="31519"/><n>（需异性组队交付）</n><newline/><n color="GXColorGreen">    1.选中异性后，鼠标右键点击该玩家头像。</n><newline/><n color="GXColorGreen">    2.选择交互动作，选择依偎或拥抱，等待对方接受即可</n></p>]]),
		prompttext = [[   与异性组队拥抱或依偎1分钟]],
		tracebegin = [[<p><newline/><n>与异性组队拥抱或依偎1分钟后回复：</n><goto id="204" mapid="156" flagpoint="1" taskid="31519"/></p>]],
		traceend = [[<p><newline/><n>与异性组队拥抱或依偎1分钟后回复：</n><goto id="204" mapid="156" flagpoint="1" taskid="31519"/></p>]],
	...
	{
		color = TaskColor_White,
		desctext = ([[<p><newline/><n font="3" color="GXColorYellow">[随机]浪漫情缘</n><newline/><image pack="INTERFACE_PACK" infoname="INTERFACE_40_4_P"/><newline/><n font="3" color="GXColorYellow">任务进程：</n><newline/><n>    驾驶双人马车，与异性一起回复</n><goto id="199" mapid="156" flagpoint="1" taskid="31519"/></p>]]),
		prompttext = [[   驾驶双人马车，与异性一起回复维纳斯。]],
		tracebegin = [[<p><newline/><n>与异性同乘双人马车</n><newline/><n>回复：</n><goto id="199" mapid="156" flagpoint="1" taskid="31519"/></p>]],
		traceend = [[<p><newline/><n>与异性同乘双人马车</n><newline/><n>回复：</n><goto id="199" mapid="156" flagpoint="1" taskid="31519"/></p>]],
	...
	{
		color = TaskColor_White,
		desctext = ([[<p><newline/><n font="3" color="GXColorYellow">[随机]浪漫情缘</n><newline/><image pack="INTERFACE_PACK" infoname="INTERFACE_40_4_P"/><newline/><n font="3" color="GXColorYellow">任务进程：</n><newline/><n>    通过</n><goto id="207" mapid="156" flagpoint="1" taskid="31519"/><n>跳转返回，回复</n><goto id="60789" mapid="5" flagpoint="1" taskid="31519"/><n>,可别忘记和队伍中帮忙的朋友说声再见哦！</n></p>]]),
		prompttext = [[   需要找到罗密欧。]],
		tracebegin = [[<p><newline/><n>通过</n><goto id="207" mapid="156" flagpoint="1" taskid="31519"/><newline/><n>离开，回复：</n><goto id="60789" mapid="5" flagpoint="1" taskid="31519"/></p>]],
		traceend = [[<p><newline/><n>通过</n><goto id="207" mapid="156" flagpoint="1" taskid="31519"/><newline/><n>离开，回复：</n><goto id="60789" mapid="5" flagpoint="1" taskid="31519"/></p>]],
		...
		onfinish=
		{
			{s_actionRandomAction,{ 30, 100, { {s_actionAddItem,{31433, 0, 1,0, "1-1", "梦娜丽莎画卷"}}} }, },
		},
	},
}
