RoleTaskInfo33503 =
{
	...
	subtask1 =
	{
		...
		task = {s_taskTalk, {60789, 60798}},
		onfinish=
		{
			{s_actionRandomAction,{ 80, 100, { {s_actionAddItem,{31450, 0, 1,0, "1-1", "RoleTaskInfo33503_2"}}, {s_actionAddItem,{31451, 0, 1,0, "1-1", "RoleTaskInfo33503_2"}}, } }, },
		},
	},
	subtask2 =
	{
		color = TaskColor_Purple,
		desctext = ([[<p><newline/><n font="3" color="GXColorYellow">[随机]吟游诗人</n><newline/><image pack="INTERFACE_PACK" infoname="INTERFACE_40_4_P"/><newline/><n font="3" color="GXColorYellow">任务进程：</n><newline/><n>回复：</n><n></n><goto id="60789" mapid="5" flagpoint="1" taskid="33503"/><newline/><newline/><n font="3" color="GXColorYellow">任务描述：</n><newline/><n>    最近帝都有很多吟游诗人在游逛，去寻找他们，听听吟游诗人在各地游历收集到的故事吧，不过没有人知道现在他们在哪个地方歌唱哦(找不到的话，尝试原地等待2分钟)如果运气好的话，完成任务还有几率获得诗集上、下篇。</n><newline/></p>]]),
		prompttext = [[   需要回复达芬奇。]],
		traceend = [[<p><newline/><n>回复：</n><n></n><goto id="60789" mapid="5" flagpoint="1" taskid="33503"/></p>]],
