...
--副本创建初始化
function CopySceneInfo_2004:InitCopyScene(sid)
	--随机每层的eventid
	--变量(2-1,2-2,2-3,...2-maxzone)表明每层对应的实际eventid
	local zone_event =
		{
			...
			--{18,18,18,18,18,16,16,16,16,10,11,17,18,19,20,5,3,14,16,18,10,7,4,8},
...
--玩家进入副本提示
function CopySceneInfo_2004:OnPlayerIntoCopyScene(sid,uid)
	CopySceneInfo_2004:InitZone(sid, uid, 1)
end

--变量改变
function CopySceneInfo_2004:OnCopySceneVarChange(sid, key1, key2, newvalue, oldvalue)
end

--清除场景
function CopySceneInfo_2004:ClearNpc(sid)
...
--初始化指定层
function CopySceneInfo_2004:InitZone(sid, uid, zoneid)
