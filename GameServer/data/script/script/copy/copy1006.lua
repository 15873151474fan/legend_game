...
--副本创建初始化
function CopySceneInfo_1006:InitCopyScene(sid)
	--随机每层的eventid
...
--玩家进入副本提示
function CopySceneInfo_1006:OnPlayerIntoCopyScene(sid,uid)
	CopySceneInfo_1006:InitZone(sid, uid, 1)
end

--变量改变
function CopySceneInfo_1006:OnCopySceneVarChange(sid, key1, key2, newvalue, oldvalue)
end

--清除场景
function CopySceneInfo_1006:ClearNpc(sid)
...
--初始化指定层
function CopySceneInfo_1006:InitZone(sid, uid, zoneid)
