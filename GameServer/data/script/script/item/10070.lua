--小袋金币
function OnUseItemEvent_10070(uid,thisid,targetid, number)
    ...
    if s_deleteItemByThisID(uid,thisid,cannum,"OnUseItemEvent_10070") ~= VALUE_OK then
        return VALUE_FAIL
    end
    s_addMoneyMe(uid,MoneyType_MoneyTicket,10000000 * cannum,"使用银两袋",AddItemAction_UseItem)
