--雄黄酒
function OnUseItemEvent_16018(uid,thisid,targetid, number)
    if s_deleteItemByThisID(uid,thisid,1,"棉花糖") ~= VALUE_OK then
        return VALUE_FAIL
    end
    ...
    s_worldInfo(name .. "食用了棉花糖,获得了女神的祝福,普天同乐！", ChatPos_Sys + ChatPos_Important)
    return VALUE_OK
end
