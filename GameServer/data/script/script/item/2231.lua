--高级藏宝图
function OnUseItemEvent_2231(uid,thisid,targetid, number)
	...
	s_showbar(uid,3000,"OnUseItemEvent_2231_Callback($1,"..thisid..","..reward_type..","..reward_id..","..reward_num..")",UninterruptActionType_Treasure,VALUE_OK)
...
--进度条回调
function OnUseItemEvent_2231_Callback(uid,thisid,reward_type,reward_id,reward_num)
