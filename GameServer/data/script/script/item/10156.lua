--三倍经验5小时
function OnUseItemEvent_10156(uid,thisid,targetid, number)
    ...
    if s_deleteItemByThisID(uid,thisid,number,"OnUseItemEvent_10156") ~= VALUE_OK then
        return VALUE_FAIL
    end
    local time = 5 * 3600 * number
