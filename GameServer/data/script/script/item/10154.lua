--三倍经验1小时
function OnUseItemEvent_10154(uid,thisid,targetid, number)
    ...
    if s_deleteItemByThisID(uid,thisid,number,"OnUseItemEvent_10154") ~= VALUE_OK then
        return VALUE_FAIL
    end
    local time = 3600 * number
