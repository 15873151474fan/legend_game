--中级BOSS封印
function OnUseItemEvent_10098(uid,thisid,targetid,number)
	...
	if s_deleteItemByThisID(uid,thisid,cannum,"OnUseItemEvent_10098") ~= VALUE_OK then
        return VALUE_FAIL
    end
	
    local npctable = {17001,17002,17003,17004,17005,17006,17007,17008,17009}
