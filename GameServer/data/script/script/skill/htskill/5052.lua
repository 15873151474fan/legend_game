...
function OnUseSkill_5052(level,etype1,eid1,etype2,eid2)
    local damage  = 0;
	...
	--是否可PK
	if s_checkPK(5052,etype1,eid1,etype2,eid2) == VALUE_OK then
    ...
    MagicAttack(5052,VALUE_TYPE_MDAM,etype1,eid1,unpack(victim))
	if etype1 == SCENE_ENTRY_PLAYER then
		s_addValue(etype1,eid1,VALUE_TYPE_SKILL_5052,1)
	end
end
