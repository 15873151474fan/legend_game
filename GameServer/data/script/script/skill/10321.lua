--死神收割 待支持
function OnUseSkill_10321(level,etype1,eid1,etype2,eid2)
	...
	s_addbuff(etype1,eid1,10321,30,time1[level])
	--[[
	...
	MagicAttack(10321,VALUE_TYPE_PDAM,etype1,eid1,etype2,eid2,value)
end
