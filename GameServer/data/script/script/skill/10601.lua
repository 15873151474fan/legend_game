--心灵震爆
function OnUseSkill_10601(level,etype1,eid1,etype2,eid2)
	...
	--符文相关
	if s_getRuneDur(eid1,10601) > 0 then
		value = math.floor(value + dadd[level]*0.2)
		s_reduceRuneDur(eid1,10601)
	end
	MagicAttack(10601,VALUE_TYPE_MDAM,etype1,eid1,etype2,eid2,value)
