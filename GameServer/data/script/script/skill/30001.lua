--猎手天赋 增加物攻
function OnUseSkill_30001(level,etype1,eid1,etype2,eid2)
--[[
...
s_addbuff(etype1,eid1,30001,30,time1[level])
...
MagicAttack(30001,VALUE_TYPE_PDAM,etype1,eid1,etype2,eid2,value)
]]--
end
