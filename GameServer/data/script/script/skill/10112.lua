--不屈意志
function OnUseSkill_10112(level,etype1,eid1,etype2,eid2)
--[[
...
s_addbuff(etype1,eid1,10112,30,time1[level])
...
MagicAttack(10112,VALUE_TYPE_PDAM,etype1,eid1,etype2,eid2,value)
]]--
end
