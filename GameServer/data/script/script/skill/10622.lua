--魔舞技能-炼狱天堂-牧师
function OnUseSkill_10622(level,etype1,eid1,etype2,eid2)
	...
	for i = 1,table.getn(list), 2 do
		if list[i] ~= etype1 then	-- 处理NPC
			if s_checkPK(10622,etype1,eid1,list[i],list[i+1]) ~= VALUE_OK
	...
	DirectAttack(10622,etype1,eid1,unpack(victim))
end
