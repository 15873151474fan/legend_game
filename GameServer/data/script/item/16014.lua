--烟花(大)
function OnUseItemEvent_16014(uid,thisid,targetid, number)
    if s_deleteItemByThisID(uid,thisid,1,"玫瑰") ~= VALUE_OK then
        return VALUE_FAIL
    end
    ...
    s_worldInfo(name .. "使用了玫瑰,获得了女神的祝福,普天同乐！", ChatPos_Sys + ChatPos_Important)
    return VALUE_OK
end
