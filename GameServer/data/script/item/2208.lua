--高级藏宝图
function OnUseItemEvent_2208(uid,thisid,targetid, number)
    ...
    local reward_num  = s_getItemValue(uid,thisid,Item_Atrribute_QQ_Num)

	s_showbar(uid,3000,"OnUseItemEvent_2208_Callback($1,"..thisid..","..reward_type..","..reward_id..","..reward_num..")",UninterruptActionType_Treasure,VALUE_OK)
...
--进度条回调
function OnUseItemEvent_2208_Callback(uid,thisid,reward_type,reward_id,reward_num)
