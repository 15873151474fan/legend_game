--雄黄酒
function OnUseItemEvent_16016(uid,thisid,targetid, number)
    if s_deleteItemByThisID(uid,thisid,1,"雄黄酒") ~= VALUE_OK then
        return VALUE_FAIL
    end
    ...
    s_worldInfo(name .. "使用了雄黄酒,获得了女神的祝福,普天同乐！", ChatPos_Sys + ChatPos_Important)
    return VALUE_OK
end
