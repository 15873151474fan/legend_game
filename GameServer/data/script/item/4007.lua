--翅膀礼盒
function OnUseItemEvent_4007(uid,thisid)
	if s_deleteItemByThisID(uid,thisid,1,"翅膀礼盒7") ~= VALUE_OK then
			return VALUE_FAIL
	end

	local wing_id=290701		--翅膀baseid
	...
	if ret == 1 then
		...
		if ret2 == 1 then
			s_sysInfo("激活了七阶翅膀",ChatPos_Tips)
		end
	end
	return VALUE_OK
end
