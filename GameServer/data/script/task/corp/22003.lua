RoleTaskInfo22003 =
{
	...
	subtask1 =
	{
		...
		oncheck =
		{
			{s_checkRolePosition, {3, 215, 479, 3, "在光明城坐标(215,479)附近使用"}},
		},
		onstartbar =
		{
		...
		onsuccess =
		{
			...
			{s_actionAddItem,{31177, 0, 1, 0, "1-1", "RoleTaskInfo22003_1"}},
		},
		onfail =
		{
		...
		onfinish =
		{
			{s_actionDeleteItemByBaseID,{31177,1,"RoleTaskInfo22003_1"}},
		},
	},
}
