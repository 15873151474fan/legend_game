...
--争夺BUFF
function OnClickNpc_60853(uid,npcid)
	local ctype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local copy = rawget(_G, "CopySceneInfo_" .. ctype)
	if copy ~= nil and copy.ToReadFlag ~= nil then
		copy.ToReadFlag(copy,uid,npcid)
	end
end

function OnClickNpc_60854(uid,npcid)
	local ctype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local copy = rawget(_G, "CopySceneInfo_" .. ctype)
	if copy ~= nil and copy.ToReadFlag ~= nil then
		copy.ToReadFlag(copy,uid,npcid)
...
function OnClickNpc_60855(uid,npcid)
	local ctype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local copy = rawget(_G, "CopySceneInfo_" .. ctype)
	if copy ~= nil and copy.ToReadFlag ~= nil then
		copy.ToReadFlag(copy,uid,npcid)
...
--获取最大积分者
function CopySceneInfo_$1:GetMaxScoreUser(sid,group)
...
--旗变量
function CopySceneInfo_$1:GetFlagVar(sid,index,key)
	return s_getSceneVar(sid,3,index*100+key)
end
function CopySceneInfo_$1:SetFlagVar(sid,index,key,value)
...
function CopySceneInfo_$1:SendCopyInfo(sid,uid,ckey,cvalue)
	local vlist = {}
	local size = 1
	if ckey == 0 then
		for i=1, 4 do
	...
	local ctype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	s_sendCopyVar(ctype, sid,uid,size,vlist)
end
...
function CopySceneInfo_$1:gameOver(cid,group)
	...
	for i = 1,table.getn(list), 2 do
		...
		if gi == group then
			...
			s_incVarOldZoneUser(list[i+1],1,38,1)
			s_addVar(list[i+1],1,38,s_getVar(list[i+1],1,38)+1)
			...
			s_setVarOldZoneUser(list[i+1],1,38,0)
		...
		s_incVarOldZoneUser(list[i+1],1,37,incpoint)
		s_sysInfo(list[i+1],"incpoint:"..incpoint)
...
function OnLoopCopyScene_1Sec_$1(ctype,cid)
	CopySceneInfo_$1:Loop_1Sec(ctype,cid)
end
function CopySceneInfo_$1:Loop_1Sec(ctype,cid)
	if s_getSceneVar(cid,0,112) == 1 then
		return
	end
	local start = s_getSceneVar(cid,0,101)
...
function CopySceneInfo_$1:DoGetFlag(uid,tbreak,sid,npcindex)
...
function CopySceneInfo_$1:CheckReadState(uid,npcid)
...
function CopySceneInfo_$1:CheckNearNpc(etype,eid,npcid,maxdis)
...
for i = 110,118 do
	RegistetFunction(FormatString(CSTeamFightCopyScene,i))
end

function CopySceneInfo_110:ToReadFlag(uid,npcid)
	...
	local callback = "CopySceneInfo_110:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end

function CopySceneInfo_111:ToReadFlag(uid,npcid)
	local sid = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_ID)
	local stype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local npcindex = s_getValue(SCENE_ENTRY_NPC,npcid,VALUE_TYPE_MASTER)
	if npcindex == 0 then
	...
	local callback = "CopySceneInfo_111:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end

function CopySceneInfo_112:ToReadFlag(uid,npcid)
	local sid = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_ID)
	local stype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local npcindex = s_getValue(SCENE_ENTRY_NPC,npcid,VALUE_TYPE_MASTER)
	if npcindex == 0 then
	...
	local callback = "CopySceneInfo_112:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end

function CopySceneInfo_113:ToReadFlag(uid,npcid)
	local sid = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_ID)
	local stype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local npcindex = s_getValue(SCENE_ENTRY_NPC,npcid,VALUE_TYPE_MASTER)
	if npcindex == 0 then
	...
	local callback = "CopySceneInfo_113:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end

function CopySceneInfo_114:ToReadFlag(uid,npcid)
	local sid = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_ID)
	local stype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local npcindex = s_getValue(SCENE_ENTRY_NPC,npcid,VALUE_TYPE_MASTER)
	if npcindex == 0 then
	...
	local callback = "CopySceneInfo_114:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end

function CopySceneInfo_115:ToReadFlag(uid,npcid)
	local sid = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_ID)
	local stype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local npcindex = s_getValue(SCENE_ENTRY_NPC,npcid,VALUE_TYPE_MASTER)
	if npcindex == 0 then
	...
	local callback = "CopySceneInfo_115:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end

function CopySceneInfo_116:ToReadFlag(uid,npcid)
	local sid = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_ID)
	local stype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local npcindex = s_getValue(SCENE_ENTRY_NPC,npcid,VALUE_TYPE_MASTER)
	if npcindex == 0 then
	...
	local callback = "CopySceneInfo_116:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end

function CopySceneInfo_117:ToReadFlag(uid,npcid)
	local sid = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_ID)
	local stype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local npcindex = s_getValue(SCENE_ENTRY_NPC,npcid,VALUE_TYPE_MASTER)
	if npcindex == 0 then
	...
	local callback = "CopySceneInfo_117:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end

function CopySceneInfo_118:ToReadFlag(uid,npcid)
	local sid = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_ID)
	local stype = s_getValue(SCENE_ENTRY_PLAYER,uid,VALUE_TYPE_SCENE_TYPE)
	local npcindex = s_getValue(SCENE_ENTRY_NPC,npcid,VALUE_TYPE_MASTER)
	if npcindex == 0 then
	...
	local callback = "CopySceneInfo_118:DoGetFlag($1,$2," .. sid .. "," .. npcindex .. ")"
	s_showbar(uid,10000,callback,UninterruptActionType_TASK,1,0,1)
end
