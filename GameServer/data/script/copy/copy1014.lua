...
--副本创建初始化
function CopySceneInfo_1014:InitCopyScene(sid)
	--随机每层的eventid
	--变量(2-1,2-2,2-3,...2-maxzone)表明每层对应的实际eventid
	local zone_event =
		{
...
--玩家进入副本提示
function CopySceneInfo_1014:OnPlayerIntoCopyScene(sid,uid)
	CopySceneInfo_1014:InitZone(sid, uid, 1)
end

--变量改变
function CopySceneInfo_1014:OnCopySceneVarChange(sid, key1, key2, newvalue, oldvalue)
end

--清除场景
function CopySceneInfo_1014:ClearNpc(sid)
...
--初始化指定层
function CopySceneInfo_1014:InitZone(sid, uid, zoneid)
