--破魔斩
function OnUseSkill_10101(level,etype1,eid1,etype2,eid2)
	...
	--符文相关
	if s_getRuneDur(eid1,10101) > 0 then
		value = math.floor(value + dadd[level]*0.2)
		s_reduceRuneDur(eid1,10101)
	end
	MagicAttack(10101,VALUE_TYPE_PDAM,etype1,eid1,etype2,eid2,value)
