...
function OnUseSkill_7032(level,etype1,eid1,etype2,eid2)
	...
	--是否可PK
	if s_checkPK(7032,etype1,eid1,etype2,eid2) == VALUE_FAIL then
		return USE_SKILL_ERROR
	end
    damage  = GetAttackValue(etype1,eid1) * percent[level];
    MagicAttack(7032,VALUE_TYPE_MDAM,etype1,eid1,etype2,eid2,damage)
	if etype1 == SCENE_ENTRY_PLAYER then
		s_addValue(etype1,eid1,VALUE_TYPE_SKILL_7032,1)
	end
