...
function OnUseSkill_5013(level,etype1,eid1,etype2,eid2,curdir)
	if s_getValue(etype1,eid1,VALUE_TYPE_PROFESSION) ~= Profession_Soldier then
		return USE_SKILL_ERROR
	end

	if s_checkPK(5013,etype1,eid1,etype2,eid2) == VALUE_FAIL then
		return USE_SKILL_ERROR
	end
    ...
    local victim = {}
    local num = 0;
    s_debug("OnUseSkill_50132222222222222222222")
	--是否可PK
	if s_checkPK(5013,etype1,eid1,etype2,eid2) == VALUE_OK then
    ...
    s_debug("OnUseSkill_5013 11111111111111111111111")
	...
	if etype1 == SCENE_ENTRY_PLAYER then
		s_addValue(etype1,eid1,VALUE_TYPE_SKILL_5013,1)
	end
    MagicAttack(5013,VALUE_TYPE_PDAM,etype1,eid1,unpack(victim))
end
