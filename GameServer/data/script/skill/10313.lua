--致命射击 增加暴击 程序做
function OnUseSkill_10313(level,etype1,eid1,etype2,eid2)
--[[
...
s_addbuff(etype1,eid1,10313,30,time1[level])
...
MagicAttack(10313,VALUE_TYPE_PDAM,etype1,eid1,etype2,eid2,value)
]]--
end
