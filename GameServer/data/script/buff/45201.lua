--金刚咒(增加防御)
function OnRemoveBuffEvent_45201(level,etype,eid,time,value)
	--value=value+30
	--s_debug("OnRemoveBuffEvent_45201,,time="..time.."value="..value)
	--if time == 0 then
...
function OnAddBuffEvent_45201(level,etype, eid,value)
	--value=value+30
